...
export const DollarIcon = ({ className, size = 16 }: IconProps) => (
  <svg {...base(size, className)}>
...
export const FlameIcon = ({ className, size = 16 }: IconProps) => (
  <svg {...base(size, className)}>
...
export const UploadIcon = ({ className, size = 16 }: IconProps) => (
  <svg {...base(size, className)}>
...
export const TrendUpIcon = ({ className, size = 16 }: IconProps) => (
  <svg {...base(size, className)}>
...
export const TrendDownIcon = ({ className, size = 16 }: IconProps) => (
  <svg {...base(size, className)}>
